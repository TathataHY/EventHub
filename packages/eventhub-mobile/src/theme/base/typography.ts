...
export const typography = {
  ...
  // Acceso directo a las variantes para compatibilidad
  h1: textVariants.h1,
  h2: textVariants.h2,
  h3: textVariants.h3,
  h4: textVariants.h4,
  h5: textVariants.h5,
  h6: textVariants.h6,
  body1: textVariants.body1,
  body2: textVariants.body2,
  subtitle1: textVariants.subtitle1,
  subtitle2: textVariants.subtitle2,
  button1: textVariants.button1,
  button2: textVariants.button2,
